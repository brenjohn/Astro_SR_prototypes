...
from prototypes.data_utils import create_patches, rescale
...
torch.save(train_data, data_dir + 'eeds_train_dataset.pth')
...
torch.save(valid_data, data_dir + 'eeds_validation_dataset.pth')
...
torch.save(test_data, data_dir + 'eeds_test_dataset.pth')